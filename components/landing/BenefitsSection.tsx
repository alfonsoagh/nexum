...
export function BenefitsSection() {
  return (
    <section id="beneficios" className="border-t border-[#d8d1d1]/20 bg-[#f4f8ff] py-20 sm:py-24">
          ...
          {benefits.slice(0, 3).map((benefit, index) => (
            <article
              ...
              className={`group bg-white p-8 transition-colors duration-300 ${
                index === 0
                  ? "border-l-4 border-[#1e4fa6]"
                  : index === 1
                    ? "border-l-4 border-[#1e4fa6]/60"
                    : "border-l-4 border-[#1e4fa6]/35"
              } fx-card`}
            >
