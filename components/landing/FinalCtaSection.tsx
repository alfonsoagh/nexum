...
export function FinalCtaSection() {
  return (
    <section id="contacto" className="border-t border-[#d8d1d1]/20 bg-[#f4f8ff] py-24 sm:py-28">
      <Container>
        <div
          data-reveal
          className="relative overflow-hidden border border-[#d8d1d1]/25 bg-white px-6 py-14 sm:px-10 sm:py-20"
        >
          <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_-5%,rgba(30,79,166,0.18),transparent_45%)]" />
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 font-display text-5xl font-black uppercase leading-[0.9] tracking-tight text-[#111111] sm:text-7xl">
              ...
              <span className="block text-[#1e4fa6]">hoy mismo</span>
            </h2>
