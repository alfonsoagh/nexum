...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -left-10 top-16 h-40 w-40 rounded-full bg-[#d61f2c]/15 blur-3xl fx-float-slow" />
      <div className="pointer-events-none absolute right-0 top-0 hidden h-full w-1/2 bg-[radial-gradient(circle_at_50%_50%,rgba(214,31,44,0.16),transparent_60%)] lg:block" />
      <div className="pointer-events-none absolute right-16 top-24 hidden h-56 w-56 rounded-full bg-[#ff5c6c]/12 blur-3xl lg:block fx-float-slower" />
      ...
      <Container className="relative z-10 grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="flex flex-col gap-8">
          ...
          <div className="space-y-4">
            ...
            >
              IMPULSA TU NEGOCIO CON <span className="text-[#d61f2c]">TECNOLOGÍA</span>{" "}
              Y DISEÑO QUE <span className="text-[#ff5c6c]">SÍ VENDE</span>.
            </h1>
            <p
              data-reveal
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {heroMetrics.map((metric, index) => (
              ...
              >
                <p className="font-display text-2xl font-bold uppercase tracking-tight text-[#d61f2c]">
                  {metric.value}
                </p>
        ...
        <div data-reveal data-reveal-delay="220" className="relative hidden min-h-[520px] lg:block">
          <div className="absolute inset-8 border border-[#d8d1d1]/25 bg-white/85 backdrop-blur-sm">
            <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(214,31,44,0.15),transparent_45%)]" />
            <div className="absolute bottom-8 left-8 right-8 border-t border-[#d8d1d1]/30 pt-6">
              ...
              <p className="font-display text-4xl font-black uppercase tracking-tight text-[#d61f2c]">
